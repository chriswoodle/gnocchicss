...
export class Grid implements RuleGenerator {
    generate(): GeneratedPartial {
        const rules: Rule[] = [
            {
                name: "grid-cols-1",
                rule: "grid-template-columns: repeat(1, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-2",
            ...
            {
                name: "grid-cols-3",
                rule: "grid-template-columns: repeat(3, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-4",
                rule: "grid-template-columns: repeat(4, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-5",
                rule: "grid-template-columns: repeat(5, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-6",
                rule: "grid-template-columns: repeat(6, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-7",
                rule: "grid-template-columns: repeat(7, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-8",
                rule: "grid-template-columns: repeat(8, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-9",
                rule: "grid-template-columns: repeat(9, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-10",
                rule: "grid-template-columns: repeat(10, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-11",
                rule: "grid-template-columns: repeat(11, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-12",
                rule: "grid-template-columns: repeat(12, minmax(0, 1fr));"
            },
            {
                name: "grid-cols-none",
                rule: "grid-template-columns: none;"
            },
            {
                name: "grid-cols-subgrid",
                rule: "grid-template-columns: subgrid;"
            },
